                ...
                <div className="container flex mx-auto ">
                    ...
                    <div className="content w-3/4 pl-4 mb-20">
                        <div className="card rounded-lg drop-shadow-xl bg-white border py-10 px-6">
                            <p className='text-2xl font-semibold text-start'>Data Perusahaan</p>
                            <hr className='border-1 border-gray-400 my-6' />
                            <form className="form">
                                <p className='text-md text-start text-gray-400 mb-3'>Nama Perusahaan</p>
                                <input type="text" name='fullName' placeholder='Masukan nama perusahaan anda...' className='w-full rounded-lg py-2 px-2 border mb-8' />
                                <p className='text-md text-start text-gray-400 mb-3'>Bidang</p>
                                <input type="text" name='fullName' placeholder='Masukan bidang perusahaan anda...' className='w-full rounded-lg py-2 px-2 border mb-8' />
                                ...
                                <input type="email" name='fullName' placeholder='Masukan email anda...' className='w-full rounded-lg py-2 px-2 border mb-8' />
                                <p className='text-md text-start text-gray-400 mb-3'>Intagram</p>
                                <input type="text" name='fullName' placeholder='Masukan nama instagram anda...' className='w-full rounded-lg py-2 px-2 border mb-8' />
                                <p className='text-md text-start text-gray-400 mb-3'>Nomor Telepon</p>
                                <input type="number" name='fullName' placeholder='Masukan nomor telepon anda...' className='w-full rounded-lg py-2 px-2 border mb-8' />
                                <p className='text-md text-start text-gray-400 mb-3'>LinkedIn</p>
                                <input type="text" name='fullName' placeholder='Masukan nama linkedin anda...' className='w-full rounded-lg py-2 px-2 border mb-8' />
                            </form>
                        </div>
                    </div>
                </div>
