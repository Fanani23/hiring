  ...
  return (
    <div>
        ...
        <div className="mainContent">
            <div className={"container my-20 rounded-xl pb-52 overflow-hidden shadow-xl mx-auto "+styles.bodycontainer}>
              ...
              <div className="content-user">
                ...
                <div className="content pt-6">
                  ...
                  <div className="location my-6 flex justify-center">
                    ...
                    <p className='text-lg text-neutral-400 ml-3'>Jakarta Jakarta Barat, Indonesia</p>
                  </div>
                  ...
                  <button className={'border-2 w-64 h-12 rounded-lg '+styles.btn}>Edit Profile</button>
                  <div className="content-contact my-10 w-72 grid justify-start mx-auto">
                    ...
                    <Link className='flex mt-8'><img src={contactPhone} alt="contact" className={'mr-8 '+styles.imgContact} /><p className='text-lg text-neutral-400'>08123456789</p></Link>
                    <Link className='flex mt-8'><img src={contactLinkedin} alt="contact" className={'mr-8 '+styles.imgContact} /><p className='text-lg text-neutral-400'>irfansss</p></Link>
                  </div>
                </div>
              </div>
            </div>
