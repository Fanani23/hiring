    ...
    <div class={styles.container}>
      ...
      <div class="pl-4 ml-4 container">
        ...
        <form class={styles.form}>
          ...
          <input
            type="nama"
            class="form-control mb-2 py-1 w-full "
            name="name"
          ...
          <input
            type="konfirKataSandi"
            class="form-control mb-2 py-1 w-full"
            name="konfirKataSandi"
            placeholder="Masukan konfirmasi kata sandi"
          />
          <button
            type="submit"
            class="text-center bg-yellow-500 text-white w-full py-1 mt-1 rounded font-bold"
          >
            Daftar
          </button>
        </form>
        <p class="text-right text-sm">
          ...
          <a class="text-yellow-500" href="/loginn">
            Masuk disini
          </a>
        </p>
      </div>
