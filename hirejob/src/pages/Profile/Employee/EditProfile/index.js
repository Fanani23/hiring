            ...
            <div className="content w-3/4 pl-4">
              <div className="card rounded-lg drop-shadow-xl bg-white border py-10 px-6">
                ...
                <form className="form">
                  ...
                  <input
                    type="text"
                    name="fullName"
                    placeholder="Masukan tempat kerja anda..."
                    className="w-full rounded-lg py-2 px-2 border mb-8"
                  />
                  <p className="text-md text-start text-gray-400 mb-3">
                    Deskripsi Singkat
              ...
              <div className="card rounded-lg drop-shadow-xl bg-white mt-10 border py-10 px-6">
                ...
                <form className="form flex">
                  <input
                    ...
                    className="rounded-lg w-10/12 py-2 px-2 border"
                  />
                  <button
                    className={
                      "border ml-4 rounded-lg text-white font-semibold " +
                      styles.btnSkill
                    }
                  >
                    Simpan
              ...
              <div className="card rounded-lg drop-shadow-xl bg-white mt-10 border py-10 px-6">
                ...
                <form action="">
                  ...
                  <div className="wrapper w-full flex">
                    ...
                    <div className="wrapper w-1/2 pr-5">
                      ...
                      <input
                        type="number"
                        name="fullName"
                        placeholder="Masukan lama pengalaman anda..."
                        className="w-full rounded-lg py-2 px-2 border mb-8"
                      />
                    </div>
                  </div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg py-32 px-2 border mb-8"
                  />
                  <hr className="border-1 border-gray-400 my-6" />
                  <button
                    className={
                      "w-full py-4 text-lg font-semibold rounded-lg " +
                      styles.btnPengalaman
                    }
                  >
              ...
              <div className="card rounded-lg drop-shadow-xl bg-white mt-10 mb-20 border py-10 px-6">
                ...
                <input
                  type="text"
                  name="fullName"
                  placeholder="Masukan aplikasi anda..."
                  className="w-full rounded-lg py-2 px-2 border mb-8"
                />
                <p className="text-md text-start text-gray-400 mb-3">
                  Link repository
                ...
                <input
                  type="text"
                  name="fullName"
                  placeholder="Masukan link repository anda..."
                  className="w-full rounded-lg py-2 px-2 border mb-8"
                />
                <p className="text-md text-start text-gray-400 mb-3">
                  Type Portofolio
                ...
                <input
                  type="text"
                  name="fullName"
                  placeholder="Masukan tipe portofolio anda..."
                  className="w-full rounded-lg py-2 px-2 border mb-8"
                />
                <p className="text-md text-start text-gray-400 mb-3">
                  Upload Gambar
