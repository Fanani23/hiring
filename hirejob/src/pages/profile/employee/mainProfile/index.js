    ...
    <div className={styles.body}>
      ...
      <section>
        <div className="mainContent">
          <div
            className={
              "container my-20 rounded-xl overflow-hidden shadow-xl mx-auto " +
            ...
            <div className="content-user">
              ...
              <div className="content pt-6">
                ...
                <div className="content-contact my-10 w-72 grid justify-start mx-auto">
                  ...
                  <Link className="flex mt-8">
                    <img
                      ...
                      className={"mr-8 " + styles.imgContact}
                    />
                    <p className="text-lg text-neutral-400">irfanss</p>
                  </Link>
                  <Link className="flex mt-8">
                    <img
                      src={contactGitlab}
                ...
                <div className="wrapper-portofolio flex my-20">
                  <Link>
                    <p className="text-2xl ml-20">Portofolio</p>
                  </Link>
                  <Link>
                    <p className="text-2xl ml-20">Pengalaman Kerja</p>
                  </Link>
                </div>
                {/* <Portofolio /> */}
                <PengalamanKerja />
